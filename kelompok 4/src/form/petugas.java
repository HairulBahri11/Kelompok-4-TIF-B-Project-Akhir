...
public class petugas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 500, -1, 40));
    ...
    private void btneditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btneditMouseClicked
        ...
        try {
            Statement statement = (Statement) koneksi.GetConnection().createStatement();
            statement.executeUpdate("UPDATE petugas SET Nama_Petugas ='" + nama + "', Nama_Inisial ='" + inisial + "', Gender ='" + gender + "', alamat ='" + alamat + "', No_HP ='" + no_telp + "', gambar='" + lblnmfile.getText() + "' WHERE Id_Petugas ='" + txtkd + "'");
            String path = new File(".").getCanonicalPath();
            FileUtils.copyFileToDirectory(file, new File(path + "/image"));
            statement.close();
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        try {
            ...
            reportSource = System.getProperty("user.dir") + "/src/report/report_petugas.jrxml";
            reportDest = System.getProperty("user.dir") + "/src/report/report_petugas.jasper";
